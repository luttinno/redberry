...
const MoreAbout = () => {
  ...
  return (
    <div className="w-[1440px] h-[2545px]">
      <Header />
      ...
      <div className="w-[1440px] h-[1290px] relative bg-[#F3F2FA]">
        ...
        <div className="w-[720px] h-[1152px] text-center relative m-auto pt-10">
          ...
          <p className="font-[FiraGO] text-[16px] font-normal leading-[28px] tracking-normal text-left absolute top-[648px] left-0">
            ...
            libero officiis unde magnam, accusamus ex fuga perferendis quas
            laudantium, soluta ea illum animi tempora iure totam assumenda
            dignissimos veritatis praesentium.
            <br /> <br />
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos
            accusantium necessitatibus illum, ipsa itaque veritatis iste
            laboriosam doloribus officia quae, eligendi magni quos dicta qui
            corrupti laudantium corporis et deserunt!
            <br />
            <br />
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt
            dolor vero aspernatur iure? Quibusdam itaque repellendus suscipit?
            Nisi, exercitationem fuga! Minus reiciendis accusamus nesciunt eaque
            quibusdam perspiciatis iure fuga assumenda? Lorem ipsum dolor sit
            amet consectetur adipisicing elit. Corporis officiis perspiciatis
            dolorum asperiores eos, illum ducimus itaque laudantium, omnis
            molestiae explicabo numquam possimus eaque ullam nam quaerat, quo
            suscipit ea!
          </p>
        </div>
      </div>
      <div className="w-[1288px] h-[700px] ">
        <p className="font-[FiraGO] text-[32px] font-bold leading-[40px] tracking-normal text-left">
          მსგავსი სტატიები
        </p>
        <button className="bg-[#E4E3EB] text-[#F3F2FA] w-[44px] h-[44px] rounded-[24px] font-[FiraGO] text-[24px] font-bold leading-[40px] hover:bg-[#5D37F3] hover:text-[#FFFFFF] [transition:0.5s_ease-in-out] ">
          &lt;
        </button>
        <button className="bg-[#E4E3EB] text-[#F3F2FA] w-[44px] h-[44px] rounded-[24px] font-[FiraGO] text-[24px] font-bold leading-[40px] hover:bg-[#5D37F3] hover:text-[#FFFFFF] [transition:0.5s_ease-in-out] ">
          &gt;
        </button>
        <div className="w-[1288px] h-[620px] flex flex-row "></div>
      </div>
    </div>
  );
};
